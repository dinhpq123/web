...
const MOCK_USERS = [
    ...
    { id: 5, email: 'quanlyde@hadiwa.vn', password: '123456', role: 'QUAN_LY_DE', name: 'Phạm Thị Ngọc', title: 'Quản lý Đê điều', avatar: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:middle"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>', badge: 'badge-cyan' },
    { id: 6, email: 'nhansu@hadiwa.vn', password: '123456', role: 'HR', name: 'Vũ Thị Mai', title: 'Tổ chức – Hành chính', avatar: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:middle"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>', badge: 'badge-green' },
...
const ROLE_BADGES = {
    ...
    SYSADMIN: 'badge-red', CHI_CUC_TRUONG: 'badge-purple', DIEU_HANH: 'badge-yellow',
    KY_THUAT: 'badge-blue', QUAN_LY_DE: 'badge-cyan', HR: 'badge-green', VIEWER: 'badge-gray',
};
