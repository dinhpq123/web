...
const RPT = {
  ...
  irrigation: {
    ...
    summary: {
      'Thành phố': {
        'Hiện trạng CTTL':   { total:1248, good:892, degraded:318, critical:38, kpi:[{l:'Tổng CTTL',v:'1.248',c:'#00c8ff'},{l:'Trạng thái tốt',v:'892',c:'var(--success)'},{l:'Xuống cấp',v:'318',c:'#ffca28'},{l:'Hư hỏng nặng',v:'38',c:'#ff5252'}] },
        'Cấp phép Thủy lợi': { total:284, approved:198, pending:62, rejected:24, kpi:[{l:'Tổng hồ sơ',v:'284',c:'#00c8ff'},{l:'Đã cấp',v:'198',c:'var(--success)'},{l:'Đang xử lý',v:'62',c:'#ffca28'},{l:'Từ chối',v:'24',c:'#ff5252'}] },
        'Vi phạm Thủy lợi':  { total:142, resolved:98, processing:32, unresolved:12, kpi:[{l:'Tổng vi phạm',v:'142',c:'#ff5252'},{l:'Đã xử lý',v:'98',c:'var(--success)'},{l:'Đang xử lý',v:'32',c:'#ffca28'},{l:'Chưa xử lý',v:'12',c:'#ff5252'}] },
        'Kiểm định An toàn':  { total:42, ok:28, warning:8, overdue:6, kpi:[{l:'Tổng đập/hồ',v:'42',c:'#00c8ff'},{l:'An toàn',v:'28',c:'var(--success)'},{l:'Cần theo dõi',v:'8',c:'#ffca28'},{l:'Quá hạn KĐ',v:'6',c:'#ff5252'}] },
        'Đầu tư & Nâng cấp': { total:38, budget:'856 tỷ', completed:22, ongoing:12, planned:4, kpi:[{l:'Tổng dự án',v:'38',c:'#00c8ff'},{l:'Hoàn thành',v:'22',c:'var(--success)'},{l:'Đang thi công',v:'12',c:'#ffca28'},{l:'Kế hoạch',v:'4',c:'var(--muted)'}] },
      },
      'Công ty Thủy lợi': {
        'Hiện trạng CTTL':   { total:312, good:228, degraded:72, critical:12, kpi:[{l:'Tổng CTTL quản lý',v:'312',c:'#00c8ff'},{l:'Trạng thái tốt',v:'228',c:'var(--success)'},{l:'Xuống cấp',v:'72',c:'#ffca28'},{l:'Hư hỏng nặng',v:'12',c:'#ff5252'}] },
        'Cấp phép Thủy lợi': { total:71, approved:52, pending:14, rejected:5, kpi:[{l:'Tổng hồ sơ',v:'71',c:'#00c8ff'},{l:'Đã cấp',v:'52',c:'var(--success)'},{l:'Đang xử lý',v:'14',c:'#ffca28'},{l:'Từ chối',v:'5',c:'#ff5252'}] },
        'Vi phạm Thủy lợi':  { total:36, resolved:25, processing:8, unresolved:3, kpi:[{l:'Tổng vi phạm',v:'36',c:'#ff5252'},{l:'Đã xử lý',v:'25',c:'var(--success)'},{l:'Đang xử lý',v:'8',c:'#ffca28'},{l:'Chưa xử lý',v:'3',c:'#ff5252'}] },
        'Kiểm định An toàn':  { total:12, ok:8, warning:3, overdue:1, kpi:[{l:'Tổng đập/hồ',v:'12',c:'#00c8ff'},{l:'An toàn',v:'8',c:'var(--success)'},{l:'Cần theo dõi',v:'3',c:'#ffca28'},{l:'Quá hạn KĐ',v:'1',c:'#ff5252'}] },
        'Đầu tư & Nâng cấp': { total:10, budget:'215 tỷ', completed:6, ongoing:3, planned:1, kpi:[{l:'Tổng dự án',v:'10',c:'#00c8ff'},{l:'Hoàn thành',v:'6',c:'var(--success)'},{l:'Đang thi công',v:'3',c:'#ffca28'},{l:'Kế hoạch',v:'1',c:'var(--muted)'}] },
      },
      'Xã / Huyện': {
        'Hiện trạng CTTL':   { total:52, good:38, degraded:11, critical:3, kpi:[{l:'Tổng CTTL xã/huyện',v:'52',c:'#00c8ff'},{l:'Trạng thái tốt',v:'38',c:'var(--success)'},{l:'Xuống cấp',v:'11',c:'#ffca28'},{l:'Hư hỏng nặng',v:'3',c:'#ff5252'}] },
        'Cấp phép Thủy lợi': { total:18, approved:12, pending:4, rejected:2, kpi:[{l:'Tổng hồ sơ',v:'18',c:'#00c8ff'},{l:'Đã cấp',v:'12',c:'var(--success)'},{l:'Đang xử lý',v:'4',c:'#ffca28'},{l:'Từ chối',v:'2',c:'#ff5252'}] },
        'Vi phạm Thủy lợi':  { total:8, resolved:5, processing:2, unresolved:1, kpi:[{l:'Tổng vi phạm',v:'8',c:'#ff5252'},{l:'Đã xử lý',v:'5',c:'var(--success)'},{l:'Đang xử lý',v:'2',c:'#ffca28'},{l:'Chưa xử lý',v:'1',c:'#ff5252'}] },
        'Kiểm định An toàn':  { total:3, ok:2, warning:1, overdue:0, kpi:[{l:'Tổng đập/hồ',v:'3',c:'#00c8ff'},{l:'An toàn',v:'2',c:'var(--success)'},{l:'Cần theo dõi',v:'1',c:'#ffca28'},{l:'Quá hạn KĐ',v:'0',c:'var(--muted)'}] },
        'Đầu tư & Nâng cấp': { total:5, budget:'38 tỷ', completed:3, ongoing:2, planned:0, kpi:[{l:'Tổng dự án',v:'5',c:'#00c8ff'},{l:'Hoàn thành',v:'3',c:'var(--success)'},{l:'Đang thi công',v:'2',c:'#ffca28'},{l:'Kế hoạch',v:'0',c:'var(--muted)'}] },
      },
    },
...
function renderReportCharts() {
  ...
  const themePalette = getChartPalette();
  // orange has no dedicated theme token (not part of the semantic --primary/--info/--cyan/
  // --success/--warning/--danger set), so it stays a literal accent color.
  const PALETTE = { cyan: themePalette.cyan, green: themePalette.success, yellow: themePalette.warning, red: themePalette.danger, purple: getThemeColor('--purple', '#2984EE'), orange: '#ff9800', muted: hexToRgba(themePalette.border, 0.5) };
  const defaults = { color: themePalette.textMuted, grid: hexToRgba(themePalette.cyan, 0.06), font: "'Inter', sans-serif" };
  ...
  if (reportTab === 'budget') {
    mkChart('rptBudgetGroupChart', {
      ...
      data: {
        labels: b.districts,
        datasets: [
          { label:'Kế hoạch (tỷ)', data:b.planned, backgroundColor:PALETTE.muted, borderColor:themePalette.border, borderWidth:1, borderRadius:3 },
