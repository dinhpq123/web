...
const DATA = {
  ...
  pumpProfiles: [
    ...
    { id: 'P03', name: 'Kịch bản Mùa Hạn', type: 'dry', isActive: false, color: '#2984EE', desc: 'Tưới luân phiên, tiết kiệm nước và điện năng, ưu tiên sinh hoạt.', conditions: 'Mực nước hồ < 60% dung tích hữu ích liên tiếp 7 ngày', schedules: { 'TV07': [[22,4]], 'TV08': [[0,4]], 'TB01': [[20,24]], 'TB02': [[0,2],[22,24]], 'TB03': [], 'CO01': [[6,10]], 'CO02': [[14,18]], 'CO03': [] } },
    ...
    { id: 'P05', name: 'Tiêu úng nội đồng', type: 'drainage', isActive: false, color: '#2984EE', desc: 'Tập trung tiêu úng ruộng khi lúa ngập > 24h sau mưa lớn.', conditions: 'Mưa 50–150mm/24h, diện tích lúa bị úng > 500ha', schedules: { 'TV07': [[6,18]], 'TV08': [[6,18]], 'TB01': [[8,20]], 'TB02': [[8,22]], 'TB03': [[6,20]], 'CO01': [[10,16]], 'CO02': [], 'CO03': [[12,20]] } },
